...
resh_chg = new_CHG.reshape((ngx,ngy))
...
plt.tricontourf(trans_xx, trans_yy, new_chg, levels=25,cmap='rainbow')
plt.axis('square')
plt.axis('off')
plt.savefig('charge density 2D slice.png', transparent=True ,dpi=400)
plt.show()
